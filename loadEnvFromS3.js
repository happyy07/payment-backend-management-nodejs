...
// Main function
const main = async () => {
  await downloadEnvFile(); // Wait until the file is downloaded
  loadEnvVariables(); // Load environment variables after the download
  // You can start your app here by requiring it after env file is loaded
  require("./app"); // This is important: start your app only after env is loaded
};
